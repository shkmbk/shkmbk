...
class MbkShareDetailsW(models.TransientModel):
    ...
    _description = "Inventory Report Details Wizard"
    ...
    def print_share_details_pdf(self):
        ...
        wbf['content_qty_border_bg'] = workbook.add_format({'align': 'right', 'num_format': '#,##', 'bold': 1, 'bg_color': '#E1E1E1'})
        ...
        for rec in objbill:
            ...
            if rec.create_date.date()< self.from_date:
                ...
                # Opening Qty
                col+=1               
                worksheet.write(count, col, sum_balance_qty,  wbf['content_qty_border'])
                # In Qty
                col+=1
                in_qty=0.00
        ...
        col =5
        worksheet.write(count - 1, col,sum_opening, wbf['content_qty_border_bg'])
        ...
        col += 1        
        worksheet.write(count - 1, col, sum_balance_qty, wbf['content_qty_border_bg'])
        col += 1        
