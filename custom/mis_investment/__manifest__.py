...

{
    ...
    'data': [
        ...
        'wizard/mbk_property_report_wizard.xml',
        'report/report_papert_format.xml',
        'report/fd_report_template.xml',
        'report/bond_report_template.xml',
        'report/budget_template.xml',
        'report/budget_variation_template.xml',
        'report/mbk_hr_template.xml',
        'report/mbk_property_template.xml',
        'wizard/bond_summaryreport_wizard.xml',
        'wizard/budget_report_wizard.xml',
        'wizard/budget_variance_report_wizard.xml',
        'wizard/mbk_hr_report_wizard.xml',
    ],
    'demo': [],
    'license': 'AGPL-3',
    'installable': True,
